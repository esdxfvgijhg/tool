...
\def\ESIEE{LIGM, UMR 8049, École des Ponts, UPEM, ESIEE Paris, CNRS,UPE, France}
...
\def\PLOTPATH{\RESPATH/plot}
\def\DATAPATH{\RESPATH/data}
...
% Figures --------------------------------------------------------------------------------
\usepackage{graphicx}
	\graphicspath{{\RESPATH/plot/}{\RESPATH/img/icon/}{\RESPATH/img/}{\RESPATH/img/1-social/}{\RESPATH/img/2-utlc/}{\RESPATH/img/A-Application/}{\RESPATH/img/B-CN/}{\RESPATH/img/C-RAN/}{\RESPATH/img/Framework/}{\RESPATH/img/Model//}{\RESPATH/img/Picture/}{\RESPATH/plot/bin/}{\RESPATH/plot/pdf/}}
