...
\usepackage{palatino}
	...
	\AtBeginNote{
		% \hspace*{-20pt}\addtolength\leftmargini{-10pt}
...
\setbeamersize{text margin left=1pt}
\setbeamersize{text margin right=1pt}
\setbeamersize{sidebar width left=1pt}
\setbeamersize{sidebar width right=1pt}
...
\addtobeamertemplate{frametitle}{\vspace*{-.1cm}}{\vspace*{-.2cm}}
...
\renewcommand{\firstpage}{
	\begin{frame}[plain,noframenumbering]
		\titlepage
			\note{
				\begin{itemize}
				\item[Hello] Hello every one
				\item[Thank] Thank you for being here today for my phd defense.

				\item[Name] My name is DJOUDI Aghiles
				\item[Profession] I am a Phd student at ESIEE school with collaboration with ECE Paris school.
				\item[Director] Under the supervision of Laurent GEORGE.

				\item[These] My talk is gonna be on ...
				\end{itemize}
			}	
	\end{frame}
}
