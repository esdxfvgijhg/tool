...
\addac{TTN}{The Things Network}
\addac{LQI}{Link Quality Indicator}
...
\addac{P^{tx}}{Transmission Power}
\addac{PS}{Payload size}
\addac{PL}{Path loss}
\addac{PktL}{Payload length}


\def\ot{\blue{$\mathcal{O}_{time}$}}
\def\os{\blue{$\mathcal{O}_{space}$}}

\addac{O_{time}}{Time Complexity}
\addac{O_{space}}{Space Complexity}
...
\addac{FCM}{Fuzzy C-Means}
\addac{LoRaWAN}{Long Range Wireless Access Network}
\addac{NB-IoT}{Narrow Band-Internet of Things}
